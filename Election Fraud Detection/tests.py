...
poll_rows2 = [{"ID":1, "State":"WA", "Pollster":"B", "Date":"Mar 21 2010"},
              {"ID":2, "State":"WA", "Pollster":"B", "Date":"Jan 07 2010"},
              {"ID":3, "State":"WA", "Pollster":"B", "Date":"Jan 08 2010"}]
...
def test_most_recent_poll_row():
    ...
    assert eq(most_recent_poll_row(poll_rows2, "B", "WA"), {"ID":1, "State":"WA", "Pollster":"B", "Date":"Mar 21 2010"})
...
def test_average_error():
    ...
    state_edges_pred_4 = {'WA': 1.0}
    state_edges_act_4 = {'WA': -1.0}
    assert eq(average_error(state_edges_pred_4, state_edges_act_4), 2.0)    
